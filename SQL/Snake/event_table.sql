...
-- (1) Market Day
INSERT INTO [event] 
(title, description, detail, category_id, capacity, start_date, starts_at, end_date, ends_at, time, location, organizer, organizer_contact, image_url, active)
VALUES (
  N'Market Day',
  N'Food, books, and handmade fair',
  N'A chill market featuring food, drinks, books, and handmade crafts by students.',
  2, 300, '2025-11-05', '10:00', '2025-11-06', '18:00', '10:00',
...
VALUES (
  ...
  10, 200, '2025-11-08', '13:00', '2025-11-08', '17:00', '13:00',
...
-- (3) Melody Room 2 – Singing Contest
INSERT INTO [event]
(title, description, detail, category_id, capacity, start_date, starts_at, end_date, ends_at, time, location, organizer, organizer_contact, image_url, active)
VALUES (
  ...
  3, 120, '2025-11-12', '17:30', '2025-11-12', '22:00', '17:30',
...
VALUES (
  ...
  6, 180, '2025-11-15', '14:00', '2025-11-15', '17:00', '14:00',
...
VALUES (
  ...
  8, 250, '2025-11-20', '18:30', '2025-11-20', '21:00', '18:30',
...
VALUES (
  ...
  2, 320, '2025-11-22', '10:00', '2025-11-23', '18:00', '10:00',
  N'Entrance to Puay Ungphakorn Library',
  N'Faculty of Liberal Arts',
  'liberalarts.contact@tu.ac.th',
...
VALUES (
  ...
  2, 150, '2025-11-26', '19:00', '2025-11-26', '21:00', '19:00',
...
-- (8) The Final Competition – Debate
INSERT INTO [event]
(title, description, detail, category_id, capacity, start_date, starts_at, end_date, ends_at, time, location, organizer, organizer_contact, image_url, active)
VALUES (
  ...
  6, 160, '2025-11-29', '13:30', '2025-11-29', '17:00', '13:30',
...
VALUES (
  ...
  6, 140, '2025-12-03', '15:00', '2025-12-03', '18:00', '15:00',
...
VALUES (
  ...
  10, 220, '2025-12-06', '10:30', '2025-12-06', '16:00', '10:30',
  N'Puay Ungphakorn Library',
  N'Thammasat Business School',
  'tbs.contact@tu.ac.th',
...
-- (11) Space Quest 25 – Next Gen Spacepreneurs
INSERT INTO [event]
(title, description, detail, category_id, capacity, start_date, starts_at, end_date, ends_at, time, location, organizer, organizer_contact, image_url, active)
VALUES (
  ...
  4, 180, '2025-12-10', '09:30', '2025-12-10', '17:00', '09:30',
...
-- (12) Digital Media Contest: Big Battle
INSERT INTO [event]
(title, description, detail, category_id, capacity, start_date, starts_at, end_date, ends_at, time, location, organizer, organizer_contact, image_url, active)
VALUES (
  ...
  6, 200, '2025-12-12', '13:00', '2025-12-12', '17:00', '13:00',
...
VALUES (
  ...
  9, 120, '2025-12-14', '09:00', '2025-12-15', '17:00', '09:00',
...
VALUES (
  ...
  1, 250, '2025-12-18', '08:00', '2025-12-19', '17:00', '08:00',
...
VALUES (
  ...
  8, 260, '2025-12-20', '18:00', '2025-12-20', '20:30', '18:00',
  N'TU Theatre',
...
-- (16) Waves of Hope – Tales from the Ocean
INSERT INTO [event]
(title, description, detail, category_id, capacity, start_date, starts_at, end_date, ends_at, time, location, organizer, organizer_contact, image_url, active)
VALUES (
  ...
  8, 180, '2025-12-22', '10:00', '2026-01-05', '17:00', '10:00',
...
-- (17) Opening Windows of Opportunity
INSERT INTO [event]
(title, description, detail, category_id, capacity, start_date, starts_at, end_date, ends_at, time, location, organizer, organizer_contact, image_url, active)
VALUES (
  ...
  9, 300, '2026-01-07', '09:00', '2026-01-07', '17:00', '09:00',
...
-- (18) CI x Cheer: Wear Your Identity
INSERT INTO [event]
(title, description, detail, category_id, capacity, start_date, starts_at, end_date, ends_at, time, location, organizer, organizer_contact, image_url, active)
VALUES (
  ...
  7, 90, '2026-01-10', '10:30', '2026-01-10', '15:00', '10:30',
...
VALUES (
  ...
  6, 220, '2026-01-12', '13:00', '2026-01-12', '17:00', '13:00',
  N'Innovation Page',
...
-- (20) New World – Freshmen Adventure
INSERT INTO [event]
(title, description, detail, category_id, capacity, start_date, starts_at, end_date, ends_at, time, location, organizer, organizer_contact, image_url, active)
VALUES (
  ...
  2, 500, '2026-01-15', '08:30', '2026-01-15', '16:30', '08:30',
...
VALUES (
  ...
  4, 180, '2026-01-18', '09:00', '2026-01-19', '09:00', '09:00',
  N'Thammasat Creative Space, Puay Ungphakorn Library',
...
VALUES (
  ...
  11, 120, '2026-01-20', '18:00', '2026-01-20', '21:00', '18:00',
  N'Media Lab, SC1, Rangsit Campus',
  N'Thammasat Business School',
  'tbs.contact@tu.ac.th',
  'Resourse/Poster/image 12.png',
...
VALUES (
  ...
  3, 160, '2026-01-22', '19:00', '2026-01-22', '21:30', '19:00',
  N'Contemplative Sculpture Courtyard, Rangsit Campus',
  N'Faculty of Fine and Applied Arts',
  'finearts.contact@tu.ac.th',
  'Resourse/Poster/image 3.png',
...
VALUES (
  ...
  10, 250, '2026-01-25', '10:00', '2026-01-25', '16:00', '10:00',
  N'Puay Ungphakorn Library',
  N'Thammasat Business School',
  'tbs.contact@tu.ac.th',
  'Resourse/Poster/image 2.png',
...
VALUES (
  ...
  4, 100, '2026-01-27', '09:00', '2026-01-29', '17:00', '09:00',
  N'Thammasat Creative Space, Puay Ungphakorn Library',
  N'Faculty of Science',
  'science.contact@tu.ac.th',
  'Resourse/Poster/image 11.png',
...
VALUES (
  ...
  7, 60, '2026-01-30', '10:00', '2026-01-30', '14:00', '10:00',
...
VALUES (
  ...
  6, 240, '2026-02-01', '12:00', '2026-02-02', '20:00', '12:00',
  N'100Ys. PUAY Park for the People',
  N'Faculty of Engineering',
  'engineering.contact@tu.ac.th',
  'Resourse/Poster/image 4.png',
...
VALUES (
  ...
  9, 180, '2026-02-04', '09:00', '2026-02-04', '17:00', '09:00',
  N'Sport Center 4,5, Rangsit Campus',
  N'Faculty of Science',
  'science.contact@tu.ac.th',
  'Resourse/Poster/image 17.png',
...
VALUES (
  ...
  5, 600, '2026-02-07', '08:00', '2026-02-07', '17:00', '08:00',
  N'Lecture Classroom 4 (LC.4), Rangsit Campus',
  N'Faculty of Political Science',
  'polisci.contact@tu.ac.th',
  'Resourse/Poster/image 7.png',
...
VALUES (
  ...
  2, 350, '2026-02-10', '10:00', '2026-02-11', '18:00', '10:00',
  N'Entrance to Puay Ungphakorn Library',
  N'Faculty of Liberal Arts',
  'liberalarts.contact@tu.ac.th',
  'Resourse/Poster/image 6.png',
